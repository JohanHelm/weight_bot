...
def create_weighing_data_msg():
    return (f"Введите ваш текущий вес в килограммах с точностью до второго знака после запятой.\n"
            f"Допустимые значения от 1 до 300.\n"
            f"(На вход принимаются целые числа и десятичные дроби.)")
